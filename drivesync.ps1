...
# =============================================================================
# DRIVESYNC - FOLDER SYNC SCRIPT
# =============================================================================
# PURPOSE: Automatically sync folders from D: drive to OneDrive
...
# =============================================================================
# WHAT TO IGNORE - FILES AND FOLDERS WE DON'T WANT IN ONEDRIVE
# =============================================================================
...
#   "dist",                   # Distribution/build files
  ...
  "datasets",               # Dataset folder (can be large)
  "data",                   # General data folder
  ".venv",                  # Virtual environment
  ".venv-windows",          # Virtual environment for Windows
  "*key.json*",             # Google Cloud credentials
  "mlruns",                 # MLflow runs folder
  "mlartifacts",            # ML artifacts folder
  "models",                 # Model files (can be large)
  ".cache",                 # Cache files
  "site/",                  # Site generated by Makefile
  ".claude",                # Claude files
  ...
  ".playwright",            # Playwright cache/artifacts
  ".npm",                   # npm cache
  ".yarn",                  # Yarn cache
...
function Start-Sync {
    Write-Log "=== Starting Sync: D:\ -> OneDrive ==="

    # STEP 1: Check and create destination folder if needed
    if (!(Test-Path $OneDrivePath)) {                           # If OneDrive folder doesn't exist
        New-Item -ItemType Directory -Path $OneDrivePath -Force # Create it
    ...
    Write-Log "Destination: $OneDrivePath"
    ...
    $robocopyArgs = @(
        ...
        "`"$OneDrivePath`"",      # TO: Destination folder
    ...
    try {
        ...
        if ($LASTEXITCODE -le 7) {
            ...
            Write-Log "Files copied from D:\ to OneDrive"
        } else {
...
Write-Host "DriveSync Starting..."
Write-Host "From: D:\workspace"
Write-Host "To: OneDrive\lisekarimi"
Write-Host "Log: D:\Logs\sync_onedrive.txt"
Write-Host ""
